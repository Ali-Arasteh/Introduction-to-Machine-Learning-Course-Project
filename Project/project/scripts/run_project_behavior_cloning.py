...
from project.agents.bc_agent import BCAgent
from project.policies.loaded_gaussian_policy import Loaded_Gaussian_Policy
...
def main():
    ...
    parser.add_argument('--eval_batch_size', type=int, default=200) # eval data collected (in the env) for logging metrics
